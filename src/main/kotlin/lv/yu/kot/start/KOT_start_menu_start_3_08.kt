 ...
 * 
 * Kotlin program     KOT_start_menu_start_3_08.kt     Apache License 2.0
 *      
...
fun KOT_start_menu_start_3_08() {

        var menu_Start_3 = JMenu("Start3")
            menu_Start_3.mnemonic = KeyEvent.VK_3  //  ALT 3
            menu_Start_3.toolTipText = "Start3 commands"    
            
        var item_St31 = JMenuItem("St31")
        ...
        var item_St32 = JMenuItem("St32")
            ...
            lv.yu.kot.menubar_08.add(menu_Start_3)      

}  //  end KOT_start_menu_start_3_08()
