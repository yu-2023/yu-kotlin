...
/** KOT_09_internal_frames_change demonstrates Kotlin Internal Frames Change in Kotlin Frame */
...
//------------------------------
    ...
    var title = "KOTLIN -- KOT_09_internal_frames_change -- v. 2023.12.12"

        frame_09.setTitle("     " + title)

        frame_09.setBounds(10+8*40+150, 10+8*40, 1000, 600)

        frame_09.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE)
...
fun main() {
             SwingUtilities.invokeLater(::KOT_09_internal_frames_change)
}  //  end main()
