...
/** KOT_08_internal_frames demonstrates Kotlin Internal Frames in Kotlin Frame */
...
//------------------------------
    ...
    val title = "KOTLIN -- KOT_08_internal_frames -- v. 2023.12.12"

        frame_08.setTitle("     " + title)

        frame_08.setBounds(10+7*40+150, 10+7*40, 1000, 600)

        frame_08.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE)
...
fun main() {
             SwingUtilities.invokeLater(::KOT_08_internal_frames)
}  //  end main()
