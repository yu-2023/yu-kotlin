 ...
 * 
 * Kotlin program     KOT_load_menu_start_10.kt     Apache License 2.0
 *      
...
//------------------------------
          ...
          item_Load.addActionListener { e: ActionEvent -> lv.yu.kot.load.KOT_load_visualize_10() }

//------------------------------
            
        lv.yu.kot.start.menu_Menu_10.add(item_Load)

        lv.yu.kot.menubar_10.add(lv.yu.kot.start.menu_Menu_10)
            
//------------------------------
       
}  //  end KOT_load_menu_start_10()
