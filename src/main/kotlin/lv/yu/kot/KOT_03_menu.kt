...
/** KOT_03_menu demonstrates Kotlin Menu in Kotlin Frame */
fun KOT_03_menu() {
...
//------------------------------
    ...
    val title = "KOTLIN -- KOT_03_menu -- v. 2023.12.12"

        frame_03.setTitle("     " + title)

        frame_03.setBounds(10+2*40+150, 10+2*40, 1000, 600)

        frame_03.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE)
...
fun main() {
	         SwingUtilities.invokeLater(::KOT_03_menu)
}  //  end main()
