 ...
 *
 * Kotlin program     KOT_04_menu_wrap.kt     Apache License 2.0
 *
...
/** KOT_04_menu_wrap demonstrates Kotlin Menu Wrap in Kotlin Frame */
...
//------------------------------
    ...
    val title = "KOTLIN -- KOT_04_menu_wrap -- v. 2023.12.12"

        frame_04.setTitle("     " + title)

        frame_04.setBounds(10+3*40+150, 10+3*40, 1000, 600)

        frame_04.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE)
...
//------------------------------
    ...
    val icon_Xxxx        = ImageIcon(Thread.currentThread().contextClassLoader.getResource("lv/yu/kot/KOT_resources/xxxx.png"))
...
//------------------------------
        ...
        menubar_04.setLayout( lv.yu.kot.JAV_LIB_wrap_layout (lv.yu.kot.JAV_LIB_wrap_layout.LEFT, 0, 0) )
...
}  //  end KOT_04_menu_wrap()

//------------------------------

fun main() {
	         SwingUtilities.invokeLater(::KOT_04_menu_wrap)
}  //  end main()
