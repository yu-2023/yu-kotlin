...
;;;-----------------------------
 ...
 ;
 ; Clojure program     CLO_05_action.clj     Apache License 2.0
 ;
...
(ns ^{:doc    "Clojure package     lv.yu.clz
    ...
    lv.yu.clz.CLO-05-action  ;;  CLO-05-action demonstrates Clojure Action in Clojure Frame
...
;;------------------------------
  ...
  (gen-class
    :name lv.yu.clz.CLO_05_action
    :main true
    :methods [[CLO_05_action [] void]]
  )
...
;;------------------------------
    ...
    (def title (str "CLOJURE -- CLO_05_action -- v. 2023.12.12"))

    (doto frame

        (.setTitle (str "     " title))

        (.setBounds (+ 10 (* 4 40) 300) (+ 10 (* 4 40)) 1000 600)
