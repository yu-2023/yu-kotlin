...
(ns ^{:doc    "Clojure package     lv.yu.clz
    ...
    lv.yu.clz.CLO-06-internal-frame-one  ;;  CLO-06-internal-frame-one demonstrates Clojure Internal Frame One in Clojure Frame
...
;;------------------------------
    ...
    (def title (str "CLOJURE -- CLO_06_internal_frame_one -- v. 2023.12.12"))
